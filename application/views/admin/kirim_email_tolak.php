            ...
            <form method="post" action="<?php echo base_url('admin/kirim_email/prosespengiriman') ?>">
                <?php foreach ($email as $em) : ?>
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Pesan</label>
                            <textarea type="text" name="isi" class="form-control" rows="5">Maaf, Anda harus mengirimkan berkas dengan lengkap dan benar. Silahkan ulangi pendaftar jika ingin melanjutkan </textarea>
                        </div>
