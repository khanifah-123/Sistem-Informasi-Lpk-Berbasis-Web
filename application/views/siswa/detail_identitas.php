        ...
        <div class="col-md-10">
            ...
            <table class="table table-striped table-hover table-bordered">
                <?php if (is_array($siswa) || is_object($siswa)) {
                    foreach ($siswa as $dt) : ?>
                        <img class="mb-4 border rounded-circle" width="20%" height="20%" style="display: block; margin: auto;" src="<?php echo base_url('assets/uploads/') . $dt->pas_foto ?> " style="width:150px">
                        <tr>
                            <th>NAMA</th>
            ...
            <?php echo anchor('siswa/dashboard', '<div class="btn btn-sm btn-primary pull-right">Kembali</div>
') ?><br>
        </div>
    </div>